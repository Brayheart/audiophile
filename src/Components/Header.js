      ...
      >
        ...
        {isMenuVisible && (
          <div className="bg-white text-black px-10 py-16">
            <div className="flex flex-col items-center px-10 py-5 bg-gray-100 rounded-lg mb-16 md:mb-0 w-full">
              <img
            ...
            <div className="flex flex-col items-center px-10 py-5 bg-gray-100 rounded-lg mb-16 md:mb-0 w-full md:mx-5">
              <img
                className="w-[60px] mt-[-70px] mb-5"
